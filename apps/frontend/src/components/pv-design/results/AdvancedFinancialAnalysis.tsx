  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <FinancialMetricCard
          title="LCOE"
          value={`${formatCurrency(advancedFinancial.indicadores?.custoNiveladoEnergia || 0)}/kWh`}
        ...
        <FinancialMetricCard
          title="ROI"
          value={formatPercentage(advancedFinancial.indicadores?.retornoSobreInvestimento || 0)}
          subtitle="Retorno sobre o investimento"
          icon={<LineChart className="w-6 h-6" />}
          color="from-pink-500 to-rose-600"
          trend={getTrendForMetric(advancedFinancial.indicadores?.retornoSobreInvestimento || 0, 'roi')}
        />
              ...
              <div className="space-y-4">
                 <div className="flex justify-between">
                   ...
                   <span className="font-medium text-gray-900 dark:text-white">
                     {formatCurrency(advancedFinancial.investimentoInicial || 0)}
                   </span>
                 </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">
                    {formatPercentage(advancedFinancial.indicadores?.eficienciaInvestimento || 0)}
                  </span>
                </div>
