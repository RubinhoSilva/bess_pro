...
export const PageIntroduction: React.FC = () => {
  return (
    <section className="proposal-page p-10">
      ...
      <p className="mt-4 text-gray-600 leading-relaxed">
        Investir em um sistema de energia solar fotovoltaica é mais do que uma decisão econômica inteligente; 
        é um passo em direção a um futuro mais sustentável e autônomo. Ao gerar sua própria eletricidade a 
        partir da luz do sol, uma fonte limpa, gratuita e inesgotável, você se protege contra as constantes 
        altas nas tarifas de energia e contribui para a preservação do meio ambiente.
      </p>

      <div className="mt-8">
        <img 
          className="w-full h-auto rounded-lg shadow-lg" 
          alt="Diagram of a solar panel system" 
          src="https://images.unsplash.com/photo-1679046410102-c5072c4bc29b" 
        />
      </div>
