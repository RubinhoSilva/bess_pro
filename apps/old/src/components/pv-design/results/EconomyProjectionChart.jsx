...
const EconomyProjectionChart = ({ results }) => {
    ...
    return (
        <Card className="bg-slate-800/50 border-slate-700 print:border-gray-200 print:shadow-none h-full">
            <CardHeader>
                <CardTitle className="text-white print:text-black">Projeção de Custos e Economia</CardTitle>
                <CardDescription className="text-slate-300 print:text-gray-600">Comparativo de custos e economia anual ao longo dos anos.</CardDescription>
            </CardHeader>
            <CardContent>
                <ResponsiveContainer width="100%" height={400}>
                    <AreaChart data={chartData}>
                        ...
                        />
                        <Legend />
                        <Area type="monotone" dataKey="Custo Sem FV" stroke="#ef4444" fillOpacity={1} fill="url(#colorCustoSemFV)" />
                        <Area type="monotone" dataKey="Custo Com FV" stroke="#f97316" fillOpacity={1} fill="url(#colorCustoComFV)" />
                        <Area type="monotone" dataKey="Economia Anual" stroke="#22c55e" fillOpacity={1} fill="url(#colorEconomia)" />
                    </AreaChart>
                </ResponsiveContainer>
            </CardContent>
        </Card>
...
export default EconomyProjectionChart;