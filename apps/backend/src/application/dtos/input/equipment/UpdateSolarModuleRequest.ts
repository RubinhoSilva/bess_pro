...
/**
 * Update Solar Module Request - Alinhado com @bess-pro/shared
 * 
 * Este DTO estende o tipo compartilhado para adicionar campos específicos
 * do backend como userId para controle de acesso.
 */
export interface UpdateSolarModuleRequest extends UpdateModuleRequest {
  /** ID do usuário proprietário do módulo (para verificação de permissão) */
  userId?: string;
}

/**
 * Update Solar Module Command - Mantido para compatibilidade
 * @deprecated Use UpdateSolarModuleRequest instead
 */
