...
/**
 * Create Solar Module Request - Alinhado com @bess-pro/shared
 * 
 * Este DTO estende o tipo compartilhado para adicionar campos específicos
 * do backend como userId para controle de acesso.
 */
export interface CreateSolarModuleRequest extends CreateModuleRequest {
  /** ID do usuário proprietário do módulo */
  userId: string;
...
/**
 * Create Solar Module Command - Mantido para compatibilidade
 * @deprecated Use CreateSolarModuleRequest instead
 */
