...
export const CalculationConstants = {
  ...
  API_TIMEOUTS: {
    ...
    /**
     * Timeout cálculos completos
     * @unit ms
     * @source PVGIS + ModelChain
     * @lastUpdate 2024-01
     */
    CALCULATION_TIMEOUT_MS: 180000,

    /**
     * Timeout irradiação mensal
     * @unit ms
     * @source PVGIS API lenta
     * @lastUpdate 2024-01
     */
    IRRADIATION_TIMEOUT_MS: 120000,

    /**
     * Timeout cálculos financeiros
     * @unit ms
     * @source Análise financeira complexa
     * @lastUpdate 2024-01
     */
    FINANCIAL_TIMEOUT_MS: 60000,

    /**
     * Timeout cálculos MPPT
     * @unit ms
     * @source Cálculos elétricos
     * @lastUpdate 2024-01
     */
    MPPT_TIMEOUT_MS: 30000,
  } as const,
  ...
  FINANCIAL_DEFAULTS: {
    /**
     * Investimento inicial padrão
     * @unit R$
     * @source Sistema residencial médio
     * @lastUpdate 2024-01
     */
    DEFAULT_INVESTMENT_BRL: 25000,

    /**
     * Taxa de financiamento padrão
     * @unit % ao ano
     * @source Financiamento solar Brasil
     * @lastUpdate 2024-01
     */
    DEFAULT_FINANCING_RATE: 0.12,

    /**
     * Custo manutenção anual padrão
     * @unit R$/ano
     * @source O&M sistemas solares
     * @lastUpdate 2024-01
     */
    DEFAULT_MAINTENANCE_COST_BRL: 200,
  ...
  /**
   * Constantes decimais úteis
   */
  DECIMALS: {
    /**
     * 10% em formato decimal
     * @unit adimensional
     * @source Conversão percentual
     * @lastUpdate 2024-01
     */
    TEN_PERCENT_DECIMAL: 0.1,

    /**
     * 1% em formato decimal
     * @unit adimensional
     * @source Conversão percentual
     * @lastUpdate 2024-01
     */
    ONE_PERCENT_DECIMAL: 0.01,
  } as const,
} as const;
...
export type ApiTimeoutsConstants = typeof CalculationConstants.API_TIMEOUTS;
...
export type DecimalsConstants = typeof CalculationConstants.DECIMALS;